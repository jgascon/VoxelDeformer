...
//Putting rayStart and rayStop between [0,1]
vec3 dims = 1.0 / (aabb_max - aabb_min);
rayStart = (rayStart - aabb_min) * dims;
rayStop = (rayStop - aabb_min) * dims;
